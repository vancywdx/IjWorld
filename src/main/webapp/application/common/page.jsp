...
<head>
    <%--引入layui的css--%>
    <link rel="stylesheet" href="css/layui-page.css" media="all">
    <%--layui的js--%>
            ...
            layui.use('laypage', function(){
                ...
                laypage.render({
                    ...
                    jump: function(obj, first){
                        ...
                        //首次不执行
                        if(!first){
                           /*location.href="sysUser/getUserByCondition?currentPage="+obj.curr+"&pageSize="+obj.limit+"&userName=${userName}";*/
                            //$("#${param.bodyId}").load("${url}?currentPage="+obj.curr+"&pageSize="+obj.limit,${params});
                            location.href="${pageContext.request.contextPath }/${url}?currentPage="+obj.curr+"&pageSize="+obj.limit;
                        }
                    }
                });
            });
