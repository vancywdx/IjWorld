...
<body>
<div class="pd-20">
    <form action="goodsType/updateGoodsType" type="post" class="form form-horizontal" id="form-gtype-update">
        <input type="hidden" name="id" value="${goodsType.id}"/>
        <div class="row cl">
            <label class="form-label col-3"><span class="c-red">*</span>商品类别名：</label>
            <div class="formControls col-5">
                <input type="text" class="input-text" placeholder="" value="${goodsType.gtypeName}" name="gtypeName" datatype="*2-16" nullmsg="商品类别名不能为空">
            </div>
            <div class="col-4"> </div>
        </div>
        <div class="row cl">
        ...
        <select class="select" size="1" name="gtypeParentid" datatype="*" nullmsg="请选择所属类别！" id="gtypeParent" >
...
<script type="text/javascript">
    $(function(){
        //设置当前类别所属大类
        $("#gtypeParent").val(${goodsType.gtypeParentid});
...
//                    type:"post",
//                    data:$("#form-gtype-update").serialize(),
