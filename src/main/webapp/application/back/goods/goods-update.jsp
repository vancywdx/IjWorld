...
<body>
<div class="pd-20">
    <form action="" method="post" class="form form-horizontal" id="form-goods-update">
        <input type="hidden" name="id" value="${goods.id}"/>
        <div class="row cl">
            <label class="form-label col-2"><span class="c-red">*</span>商品名称：</label>
            <div class="formControls col-8">
                <input type="text" class="input-text" id="goodsName" name="goodsName" value="${goods.goodsName}" datatype="*2-50" nullmsg="商品名称不能为空">
            </div>
            <div class="col-2"> </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-4">
                <span class="select-box">
                    <select name="goodsBrandid" class="select" id="goodsBrandid">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-4">
                <input type="text" name="goodsPrice" id="goodsPrice" placeholder="" value="${goods.goodsPrice}" class="input-text" style="width:90%" datatype="*" nullmsg="商品价格不能为空">
                元</div>
            <div class="col-2"> </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-4">
                <input type="text" name="goodsStock" id="goodsStock" placeholder="" value="${goods.goodsStock}" class="input-text" style="width:90%" datatype="*" nullmsg="商品库存不能为空">
                件</div>
            <div class="col-2"> </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-4">
                <input type="text" name="goodsDiscount" id="goodsDiscount" placeholder="" value="${goods.goodsDiscount}" class="input-text" style="width:90%">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-2">折扣价：</label>
            <div class="formControls col-4">
                <input type="text" name="goodsPriceOff" id="goodsPriceOff" placeholder="" value="${goods.goodsPriceOff}" class="input-text" style="width:90%">
                元</div>
        </div>
        <div class="row cl">
            <label class="form-label col-2"><span class="c-red">*</span>商品描述：</label>
            <div class="formControls col-8">
                <textarea name="goodsDesc" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="商品描述不能为空！" onKeyUp="textarealength(this,200)">${goods.goodsDesc}</textarea>
        ...
        <div class="row cl">
            <div class="col-10 col-offset-2">
                <input class="btn btn-primary radius" type="submit" value="&nbsp;&nbsp;立即保存&nbsp;&nbsp;">
...
<script type="text/javascript">
    $(function() {
        ...
        $("#goodsParentid").val(${goods.goodsParentid});
        $("#goodsFatherid").val(${goods.goodsFatherid});
        $("#goodsBrandid").val(${goods.goodsBrandid});

//        //商品-编辑
//        $("#form-goods-update").Validform({
//            tiptype:2,
...
//                    type: 'POST',
//                    data: new FormData($("#form-goods-update")[0]),
//                    dataType: 'JSON',
//                    cache: false,
//                    processData: false,
//                    contentType: false,
